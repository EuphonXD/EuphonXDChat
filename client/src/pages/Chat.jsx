...
import { Hash, Users, Menu, X } from 'lucide-react';
  ...
  return (
    <div className="h-screen flex bg-gray-950 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header */}
        <header className="h-14 border-b border-gray-800 flex items-center px-3 sm:px-4 flex-shrink-0 bg-gray-900/50 backdrop-blur-sm">
          <button
          ...
          {selectedRoom ? (
            ...
            <div className="flex items-center gap-2 flex-1">
              ...
              <span className="text-gray-500 hidden sm:inline">选择一个聊天室或开始私聊</span>
              <span className="text-gray-500 sm:hidden">选择聊天</span>
            </div>
          )}
        ...
        <div className="flex-1 flex overflow-hidden relative">
          ...
          {/* Member Panel - Desktop: side panel, Mobile: overlay */}
            ...
            <>
              {isMobile ? (
                <>
                  ...
                  />
                  <div className="fixed bottom-0 left-0 right-0 z-50 h-[70vh] sm:h-[60vh] rounded-t-2xl overflow-hidden animate-slide-up">
                    <MemberList
